...
import { postNews } from "../../redux/actions/newsAction";
...
const NewsCreate = () => {
  ...
  return (
    <AppLayout>
      ...
      >
        <h1 className="text-2xl font-montserrat-bold"> Täzelik paýlaş </h1>
        ...
        <aside className="grid grid-cols-12 gap-5 lg:gap-10 mt-7">
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col">
            <label className="flex items-center font-bold" htmlFor="published">
              Paýlaşmak
            </label>
            <select
              id="published"
