...
import { postPost } from "../../redux/actions/postAction";
...
const NewsCreate = () => {
  ...
  return (
    <AppLayout>
      ...
      >
        <h1 className="text-2xl font-montserrat-bold"> Makala paýlaş </h1>
        ...
        <aside className="grid grid-cols-12 gap-5 lg:gap-10 mt-7">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col">
            ...
            <select
              ...
              className="border border-gray-200 bg-gray-50 focus:outline-none focus:border-gray-400 duration-300 rounded-md my-2 px-4 py-3"
            >
              <option value="post">Makalalar</option>
              <option value="event">Çäreler</option>
            </select>
          </div>
        </aside>
