...
import { getQuestionCategories } from "../../redux/actions/questionAnswerAction";
  ...
  return (
    <>
      <SmallModal isOpen={addModal} close={toggleAddModal}>
        <AddCategory close={toggleAddModal} />
      </SmallModal>
      ...
      <AppLayout>
        ...
        {categories.length === 0 && <EmptyList message={t("empty_list")} />}
